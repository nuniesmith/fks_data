...
# If the project depends on external shared (fks_shared_python), avoid shadowing
...
if local_shadow.exists():
    ...
    for mod in list(sys.modules):
        if mod == "shared_python" or mod.startswith("shared_python.") or mod == "fks_shared_python" or mod.startswith("fks_shared_python."):
